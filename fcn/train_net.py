...
from lib.fcn.train import train_net
from lib.fcn.config import cfg, cfg_from_file, cfg_from_list, get_output_dir, get_log_dir
from lib.networks.factory import get_network
from easydict import EasyDict as edict
import matplotlib

def parse_args():
    parser = argparse.ArgumentParser(description='Train a FCN network')
...
if __name__ == '__main__':
    ...
    # imgdb = edict({'path':'data/fcn_voc/pascal_augmented_train.tfrecords','name':'pascal_augmentted'})
