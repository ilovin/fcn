...
from .vgg_preprocessing import _random_crop
...
def resize_to_fixed_size(img_tensor,annotation_tensor,output_shape,mask_out_num=None):
    return scale_randomly_image_with_annotation_with_fixed_size_output(img_tensor=img_tensor,
                                                                       annotation_tensor=annotation_tensor,
                                                                       output_shape=output_shape,
                                                                       min_relative_random_scale_change=1.0,
                                                                       max_realtive_random_scale_change=1.0,
                                                                       mask_out_number=mask_out_num)
